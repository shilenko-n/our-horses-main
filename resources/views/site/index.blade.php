...
@section('page.content')
	<div class="main__cover test">
		<div class="main__cover-content">
			<div class="main__cover-content_title">Добро пожаловать на сайт «Наши Кони»!</div>
			<div class="main__cover-content_description">Ищите людей, лошадей и товары для них!</div>
