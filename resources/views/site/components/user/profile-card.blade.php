<div class="profile-card">
	@if ($showCover)
		<img class="profile-card__cover" src="https://placehold.co/1752x456" />
	@endif
	<div class="profile-card__content">
		<div class="profile-card__account profile-card__item-phone-show">
			<img class="profile-card__photo" src="{{ $user['photo'] }}" />
			<div class="profile-card__name">{{ $user['name'] }}</div>
		</div>

		<img class="profile-card__photo profile-card__item-phone-hide" src="{{ $user['photo'] }}" />
		<div class="profile-card__info">
			...
			@if ($description)
				<div class="profile-card__description">{{ $description }}</div>
			@endif

			<div class="profile-card__personal">
				<div class="profile-card__age">{{ $user['age'] }}</div>
