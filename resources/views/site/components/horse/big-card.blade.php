<div class="horse-big-card">
	...
	<div class="horse-big-card__heading">
		<div>
			<div class="horse-big-card__breadcrumbs">
				<x-breadcrumbs :items="[['url' => '/front/pages/horses/list', 'title' => $isGuest ? fake()->human(0)['name'] : 'Мои лошади']]" />
			</div>
			<h2 class="horse-big-card__title">{{ $horse['name'] }}</h2>
			<div class="horse-big-card__location"><x-icon icon="map-marker-alt-solid" /> <span>Россия, {{ $horse['location'] }}</span></div>
		</div>
		<div>
			@if (session('auth'))
				<div class="horse-big-card__actions">
					...
					@else
						...
						<x-link class="w-100-p" :href="$isDead ? '/front/pages/horses/gone-edit' : '/front/pages/horses/edit'" button icon="pencil-alt-solid" color="pale">Редактировать</x-link>
					@endif
				</div>
			@endif
		</div>
	...
	<div class="horse-big-card__params">
		<div class="horse-big-card__param">
			...
			<a class="horse-big-card__param-value horse-big-card__param-link" href="/front/pages/horses/breed">{{ $horse['breed'] }}</a>
		</div>
		<div class="horse-big-card__param">
			<div class="horse-big-card__param-name">Пол</div>
			<div class="horse-big-card__param-value">Кобыла</div>
		</div>
		<div class="horse-big-card__param">
			<div class="horse-big-card__param-name">Масть</div>
			<div class="horse-big-card__param-value">Вороной</div>
		</div>
		<div class="horse-big-card__param">
			<div class="horse-big-card__param-name">Дата рождения</div>
			<div class="horse-big-card__param-value">23.01.2018</div>
		</div>
		<div class="horse-big-card__param">
		...
		<div class="horse-big-card__param">
			...
			<div class="horse-big-card__param-value">Конкур</div>
		</div>
		<div class="horse-big-card__param">
			<div class="horse-big-card__param-name">Рост в холке</div>
			<div class="horse-big-card__param-value">156 см</div>
		</div>
		@if ($isDead)
			<div class="horse-big-card__param">
				<div class="horse-big-card__param-name">Дата смерти</div>
				<div class="horse-big-card__param-value">07.06.2023</div>
			</div>
		@endif
	</div>
</div>
