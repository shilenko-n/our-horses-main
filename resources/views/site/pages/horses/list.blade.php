		...
		<div class="horses-feed__content">
			...
			<div class="horses-feed__cards pt-0">
				...
				<div class="horses-feed__cards__cards">
					<x-horse.small-card edit-url="/front/pages/horses/edit" href="/front/pages/horses/view" hide-owner is-positioning :horse="fake()->horse()" show-button has-edit price="{{ fake()->boolean() ? fake()->numberBetween(500000, 5000000) : 0 }}" />
					<x-horse.small-card edit-url="/front/pages/horses/edit" href="/front/pages/horses/view" hide-owner is-positioning :horse="fake()->horse()" show-button has-edit price="{{ fake()->boolean() ? fake()->numberBetween(500000, 5000000) : 0 }}" />
				</div>
			</div>
