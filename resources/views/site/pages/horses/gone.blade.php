...
@section('page.content')
	<div class="horse-profile">
		<div class="horse-profile__information">
			<x-horse.big-card :horse="fake()->horse(2)" is-dead />
		...
		<div class="horse-profile__diary">
			...
			<div class="horse-profile-diary__buttons">
				<x-link href="/front/pages/diary/view" button is-block size="big" color="pale" icon="chevron-right-solid">Показать все записи</x-link>
			</div>
		</div>
