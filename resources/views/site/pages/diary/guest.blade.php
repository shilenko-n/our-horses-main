	...
	<div class="diary">
		<div class="diary__container">
			<div class="diary__header">
				...
				<x-breadcrumbs :items="[
					[
						'url' => '/front/pages/profile/guest/view',
						'title' => fake()->human(1)['name'],
					],
					[
			...
			@for ($i = 0; $i < 5; $i++)
				<x-feed-blocks.post-card href="/front/pages/diary/post-guest" :user="fake()->human(1)" :post="fake()->post()" alert-message="Пост не опубликован и виден только вам" />
			@endfor
