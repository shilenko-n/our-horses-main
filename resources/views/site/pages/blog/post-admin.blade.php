		...
		<div class="diary__container diary__container_post">
			<div class="post">
				<div class="post__header">
					...
					<div class="post__admin-actions">
						<x-forms.select label="Тема поста">
							<option>Не выбрана</option>
						</x-forms.select>
						<x-button class="w-100" disabled icon="plus-solid">В самое интересное</x-button>
					</div>
				</div>
				<x-share />
