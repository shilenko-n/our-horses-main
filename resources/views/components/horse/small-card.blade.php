...
@php
    ...
    $isSubscribed   = $attributes->has('is-subscribed');
    $isPositioning  = $attributes->has('is-positioning');
    $isRevision     = $attributes->has('is-revision');
    $hideBadges     = $attributes->has('hide-badges');
    $showButton     = $attributes->has('show-button');
    $hideOwner      = $attributes->has('hide-owner');

    $hasEdit        = $attributes->has('has-edit');
    $showButton     = $attributes->has('show-button');
